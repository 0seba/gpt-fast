...
def _load_model(checkpoint_path, device, precision, use_tp, tp_mesh):
...
def main(
    ...
    global print
    from tp import maybe_init_dist_with_mesh

    rank, tp_mesh = maybe_init_dist_with_mesh()
    ...
    print("Loading model ...")
    t0 = time.time()
    model = _load_model(checkpoint_path, device, precision, use_tp, tp_mesh)
...
if __name__ == "__main__":
    ...
    try:
        ...
        # This check is the key: only destroy if initialized.
